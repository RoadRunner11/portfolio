              ...
              >
                ...
                <div className="absolute left-0 top-2 w-[15px] h-[15px] sm:w-[23px] sm:h-[23px] flex items-center justify-center">
                  <motion.div
                    ...
                    className="w-[7px] h-[7px] rounded-full bg-accent/40 group-hover:bg-accent transition-colors duration-300 ring-[3px] ring-surface group-hover:shadow-[0_0_10px_rgba(14,165,233,0.5)]"
                  />
                </div>

                {/* Content */}
                <div className="pb-2">
                  <p className="font-mono text-xs text-gray-600 mb-1 tracking-wide">
                    {role.period}
                  </p>
